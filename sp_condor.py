...
if __name__ == "__main__":
    ...
    plt.figure()
    plt.plot(phi_list,eigenvalues_list[:,0], "-.", color='red')
    plt.plot(phi_list,eigenvalues_list[:,1], "-.", color='red')
    plt.plot(phi_list,eigenvalues_list[:,2], "-.", color='red')
    plt.plot(phi_list,eigenvalues_list[:,3], "-.", color='blue')
    plt.plot(phi_list,eigenvalues_list[:,4], "-.", color='blue')
    plt.plot(phi_list,eigenvalues_list[:,5], "-.", color='blue')
    plt.plot(phi_list,eigenvalues_list[:,6], "-.", color='blue')
    plt.grid()

    plt.xlabel(r"Flux - $L_y\frac{\Phi}{2\pi}$")
